                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="data" class="form-control datepicker" id="data" value="<?= isset($dados['data']) ? date('d/m/Y', strtotime($dados['data'])) : date('d/m/Y'); ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
