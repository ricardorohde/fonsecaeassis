...
class AdminCliente {
    ...
    public function ExeUpdate($UserId, array $Data) {
        ...
        if ($this->getResult()):
            if (is_array($this->Data['foto'])):
                ...
                $upload = new Upload;
                $upload->Image($this->Data['foto'], $this->Data['login'], 640, 'usuarios');
            endif;
    ...
    private function Create() {
        ...
        if ($Create->getResult()):
            $this->Error = ["O Cliente <b>{$this->Data['fantasia']} </b> foi cadastrado com sucesso no sistema!", WS_ACCEPT];
    ...
    private function Update() {
        ...
        $this->Data['dt_alterou'] = Check::Data(date('d/m/Y'));
