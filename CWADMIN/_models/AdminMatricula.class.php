...
class AdminMatricula {
    ...
    const Entity = 'cursos_matriculas';

    /**
     * <b>Atualizar Matricula:</b> Envelope os dados em uma array atribuitivo e informe o id de um
    ...
    /**
     * <b>Remover Matricula:</b> Informe o ID do registro que deseja remover.
     * @param INT $RegId = Id do Registro
     */
