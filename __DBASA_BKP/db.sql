...
-- Copiando dados para a tabela _fonsecaeassis_2016.banco_fotos: ~18 rows (aproximadamente)
...
-- Copiando dados para a tabela _fonsecaeassis_2016.depoimentos: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela _fonsecaeassis_2016.menu: ~11 rows (aproximadamente)
...
-- Copiando dados para a tabela _fonsecaeassis_2016.menu_sub: ~17 rows (aproximadamente)
...
-- Copiando dados para a tabela _fonsecaeassis_2016.noticias_categoria: ~0 rows (aproximadamente)
...
REPLACE INTO `usuarios` (`id`, `url_name`, `nome`, `email`, `data_nasc`, `sexo`, `login`, `senha`, `foto`, `ativo`, `nivel`, `cont_acesso`, `ip`, `ultimo_acesso`, `qm_cadastr`, `dt_cadastr`, `qm_alterou`, `dt_alterou`) VALUES
	(1, 'cw-digital-brasil', 'CW Digital - Brasil', 'admin@cwdigital.com.br', '2016-08-01', 1, 'cwdigital', 'e10adc3949ba59abbe56e057f20f883e', 'usuarios/2016/09/cwdigital.jpg', 's', 1, 96, '::1', '2016-10-07 20:11:40', 1, NULL, 3, '2016-09-07 23:22:32'),
...
-- Copiando dados para a tabela _fonsecaeassis_2016.ws_siteviews: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela _fonsecaeassis_2016.ws_siteviews_online: ~0 rows (aproximadamente)
...
REPLACE INTO `ws_siteviews_online` (`online_id`, `online_session`, `online_startview`, `online_endview`, `online_ip`, `online_url`, `online_agent`, `agent_name`) VALUES
	(22, 'rie7rmgs5c81lsoiru4fivlpd6', '2016-10-07 13:47:56', '2016-10-07 20:43:05', '::1', '/servidor/fonsecaeassis_/2016/uploads/usuarios/2016/07/anderson.png', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36', 'Chrome');
