...
class AdminCurso {
    ...
    public function ExeCreate(array $Data) {
        ...
        if ($this->Data['foto']):
            $upload = new Upload;
            $upload->Image($this->Data['foto'], $this->Data['curso'], 1024, 'cursos');
        endif;
    ...
    private function setData() {
        ...
        $cron = $this->Data['cronograma'];
        unset($this->Data['foto'], $this->Data['descricao'], $this->Data['cronograma']);
        $this->Data = array_map('strip_tags', $this->Data);
        $this->Data = array_map('trim', $this->Data);
        $this->Data['foto'] = $capa;
        $this->Data['descricao'] = $desc;
        $this->Data['cronograma'] = $cron;
    ...
    private function Create() {
        ...
        if ($Create->getResult()):
            $this->Error = ["O Curso <b>{$this->Data['curso']}</b> foi cadastrado com sucesso no sistema!", WS_ACCEPT];
